...
public:
    ...
    virtual HRESULT STDMETHODCALLTYPE CreateRenderTarget(UINT, UINT, D3DFORMAT, D3DMULTISAMPLE_TYPE, BOOL, IDirect3DSurface8**, HANDLE*) { return E_NOTIMPL; }
    virtual HRESULT STDMETHODCALLTYPE CreateDepthStencilSurface(UINT, UINT, D3DFORMAT, D3DMULTISAMPLE_TYPE, IDirect3DSurface8**, HANDLE*) { return E_NOTIMPL; }
    ...
    virtual HRESULT STDMETHODCALLTYPE SetRenderTarget(IDirect3DSurface8*, IDirect3DSurface8*) { return S_OK; }
    virtual HRESULT STDMETHODCALLTYPE GetRenderTarget(IDirect3DSurface8**) { return E_NOTIMPL; }
    ...
    virtual HRESULT STDMETHODCALLTYPE SetViewport(CONST D3DVIEWPORT8*) { return S_OK; }
    virtual HRESULT STDMETHODCALLTYPE GetViewport(D3DVIEWPORT8*) { return E_NOTIMPL; }
    ...
    virtual HRESULT STDMETHODCALLTYPE SetVertexShader(DWORD) { return S_OK; }
    virtual HRESULT STDMETHODCALLTYPE GetVertexShader(DWORD*) { return E_NOTIMPL; }
    virtual HRESULT STDMETHODCALLTYPE SetPixelShader(DWORD) { return S_OK; }
    virtual HRESULT STDMETHODCALLTYPE GetPixelShader(DWORD*) { return E_NOTIMPL; }
