...
DEFINE_GUID(IID_IDirect3D8, 0x1B42BC7A, 0x5D12, 0x11D0, 0x9D, 0x10, 0x00, 0xA0, 0xC9, 0x03, 0x4E, 0x82);
...
typedef enum { D3DDEVCAPS_EXECUTESYSTEMMEMORY = 0x00000010, D3DDEVCAPS_EXECUTEVIDEOMEMORY = 0x00000020, D3DDEVCAPS_TLVERTEXSYSTEMMEMORY = 0x00000040, D3DDEVCAPS_TLVERTEXVIDEOMEMORY = 0x00000080, D3DDEVCAPS_TEXTURESYSTEMMEMORY = 0x00000100, D3DDEVCAPS_TEXTUREVIDEOMEMORY = 0x00000200, D3DDEVCAPS_DRAWPRIMTLVERTEX = 0x00000400, D3DDEVCAPS_CANRENDERAFTERFLIP = 0x00000800, D3DDEVCAPS_TEXTURENONLOCALVIDMEM = 0x00001000, D3DDEVCAPS_DRAWPRIMITIVES2 = 0x00002000, D3DDEVCAPS_SEPARATETEXTUREMEMORIES = 0x00004000, D3DDEVCAPS_DRAWPRIMITIVES2EX = 0x00008000, D3DDEVCAPS_HWTRANSFORMANDLIGHT = 0x00010000, D3DDEVCAPS_CANBLTSYSTONONLOCAL = 0x00020000, D3DDEVCAPS_HWRASTERIZATION = 0x00040000, D3DDEVCAPS_PUREDEVICE = 0x00080000 } D3DDEVCAPS;
typedef enum { D3DCAPS_READ_SCANLINE = 0x00020000, D3DCAPS2_FULLSCREENGAMMA = 0x00002000, D3DCAPS3_ALPHA_FULLSCREEN_FLIP_OR_DISCARD = 0x00000020 } D3DCAPS;
typedef enum { D3DCURSORCAPS_COLOR = 0x00000002 } D3DCURSORCAPS;
typedef enum { D3DPMISCCAPS_MASKZ = 0x00000001, D3DPMISCCAPS_CULLNONE = 0x00000002, D3DPMISCCAPS_CULLCW = 0x00000004, D3DPMISCCAPS_CULLCCW = 0x00000008, D3DPMISCCAPS_COLORWRITEENABLE = 0x00000010, D3DPMISCCAPS_CLIPPLANESCALEDPOINTS = 0x00000020, D3DPMISCCAPS_CLIPTLVERTS = 0x00000040, D3DPMISCCAPS_TSSARGTEMP = 0x00000080, D3DPMISCCAPS_BLENDOP = 0x00000100, D3DPMISCCAPS_NULLREFERENCE = 0x00000200, D3DPMISCCAPS_INDEPENDENTWRITEMASKS = 0x00000400, D3DPMISCCAPS_PERSTAGECONSTANT = 0x00000800, D3DPMISCCAPS_FOGANDSPECULARALPHA = 0x00001000, D3DPMISCCAPS_SEPARATEALPHABLEND = 0x00002000, D3DPMISCCAPS_MRTINDEPENDENTBITDEPTHS = 0x00004000, D3DPMISCCAPS_MRTPOSTPIXELSHADERBLENDING = 0x00008000 } D3DPMISCCAPS;
typedef enum { D3DPRASTERCAPS_DITHER = 0x00000001, D3DPRASTERCAPS_ZTEST = 0x00000002, D3DPRASTERCAPS_FOGVERTEX = 0x00000004, D3DPRASTERCAPS_FOGTABLE = 0x00000008, D3DPRASTERCAPS_MIPMAPLODBIAS = 0x00000010, D3DPRASTERCAPS_ZBIAS = 0x00000020, D3DPRASTERCAPS_FOGRANGE = 0x00000040, D3DPRASTERCAPS_ANISOTROPY = 0x00000080, D3DPRASTERCAPS_WFOG = 0x00000100, D3DPRASTERCAPS_ZFOG = 0x00000200, D3DPRASTERCAPS_COLORPERSPECTIVE = 0x00000400, D3DPRASTERCAPS_SCISSORTEST = 0x00000800, D3DPRASTERCAPS_SLOPESCALEDEPTHBIAS = 0x00001000, D3DPRASTERCAPS_DEPTHBIAS = 0x00002000, D3DPRASTERCAPS_MULTISAMPLE_TOGGLE = 0x00004000 } D3DPRASTERCAPS;
typedef enum { D3DPCMPCAPS_NEVER = 0x00000001, D3DPCMPCAPS_LESS = 0x00000002, D3DPCMPCAPS_EQUAL = 0x00000004, D3DPCMPCAPS_LESSEQUAL = 0x00000008, D3DPCMPCAPS_GREATER = 0x00000010, D3DPCMPCAPS_NOTEQUAL = 0x00000020, D3DPCMPCAPS_GREATEREQUAL = 0x00000040, D3DPCMPCAPS_ALWAYS = 0x00000080 } D3DPCMPCAPS;
typedef enum { D3DPBLENDCAPS_ZERO = 0x00000001, D3DPBLENDCAPS_ONE = 0x00000002, D3DPBLENDCAPS_SRCCOLOR = 0x00000003, D3DPBLENDCAPS_INVSRCCOLOR = 0x00000004, D3DPBLENDCAPS_SRCALPHA = 0x00000005, D3DPBLENDCAPS_INVSRCALPHA = 0x00000006, D3DPBLENDCAPS_DESTALPHA = 0x00000007, D3DPBLENDCAPS_INVDESTALPHA = 0x00000008, D3DPBLENDCAPS_DESTCOLOR = 0x00000009, D3DPBLENDCAPS_INVDESTCOLOR = 0x0000000A, D3DPBLENDCAPS_SRCALPHASAT = 0x0000000B, D3DPBLENDCAPS_BOTHINVSRCALPHA = 0x0000000C, D3DPBLENDCAPS_BLENDFACTOR = 0x0000000D } D3DPBLENDCAPS;
typedef enum { D3DPRESENT_INTERVAL_DEFAULT = 0x00000000, D3DPRESENT_INTERVAL_ONE = 0x00000001, D3DPRESENT_INTERVAL_IMMEDIATE = 0x80000000 } D3DPRESENT_INTERVAL;
